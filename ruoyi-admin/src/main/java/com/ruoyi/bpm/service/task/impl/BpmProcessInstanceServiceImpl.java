...
import com.ruoyi.bpm.controller.task.vo.instance.*;
import com.ruoyi.bpm.convert.task.BpmProcessInstanceConvert;
import com.ruoyi.bpm.domain.definition.BpmProcessDefinitionExtDO;
import com.ruoyi.bpm.domain.task.BpmProcessInstanceExtDO;
import com.ruoyi.bpm.mapper.task.BpmProcessInstanceExtMapper;
import com.ruoyi.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import com.ruoyi.bpm.enums.task.BpmProcessInstanceResultEnum;
import com.ruoyi.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.ruoyi.bpm.framework.event.BpmProcessInstanceResultEventPublisher;

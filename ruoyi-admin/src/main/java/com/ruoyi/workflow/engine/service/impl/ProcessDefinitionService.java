...
public class ProcessDefinitionService implements IProcessDefinitionService {
     ...
     */
    @Override
    public Page<com.ruoyi.workflow.engine.entity.ProcessDefinition> listProcessDefinition(com.ruoyi.workflow.engine.entity.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.ruoyi.workflow.engine.entity.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition : processDefinitionList) {
            ...
            com.ruoyi.workflow.engine.entity.ProcessDefinition entity = new com.ruoyi.workflow.engine.entity.ProcessDefinition();
